...
> = {
  ...
  // --- ヨーロッパ ---
  CH: { name: 'Schweiz (スイス)', flag: '🇨🇭', region: '🏰 ヨーロッパ', lang: 'de', lat: 46.8182, lon: 8.2275, zoom: 8, dict: { step1Title: 'Schritt 1: Land wählen', step1Desc: 'Kartennamen und UI werden auf Deutsch angezeigt.', step2Title: 'Schritt 2: Profil erstellen', step3Title: 'Schritt 3: Nutzungsbedingungen (EULA)', next: 'Weiter', back: 'Zurück', startApp: '🚀 WorldSnap Starten', eulaAgree: 'Ich stimme den Nutzungsbedingungen zu', termsTitle: '📜 Nutzungsbedingungen (EULA)', map: 'Karte', ranking: 'Ranking', profile: 'Profil', addPhoto: 'Medien hinzufügen', exportMap: 'Karte teilen', view: 'Aussicht', gourmet: 'Gourmet', rain: 'Regen', myMap: 'Meine Karte', friends: 'Freunde', world: 'Weltweit', openGoogleMaps: '🧭 In Google Maps öffnen', saveSpot: '❤️ Merken', saved: '❤️ Gemerkt', report: '⚠️ Melden', block: '🚫 Blockieren', delete: '🗑️ Löschen', edit: '✏️ Bearbeiten', visited: 'Besucht', countriesUnit: 'Länder', posts: 'Beiträge', friendCode: 'Freundescode', searchPlaceholder: '🔍 Ort / #Tag suchen', cacheClear: '🧹 Cache leeren', deleteAccount: '⚠️ Konto löschen', logout: '🚪 Abmelden', close: 'Schließen' } },
  FR: { name: 'France (フランス)', flag: '🇫🇷', region: '🏰 ヨーロッパ', lang: 'fr', lat: 46.2276, lon: 2.2137, zoom: 6, dict: { step1Title: 'Étape 1 : Pays', step1Desc: 'Les noms de lieux et l’interface seront traduits en français.', step2Title: 'Étape 2 : Profil', step3Title: 'Étape 3 : Conditions', next: 'Suivant', back: 'Retour', startApp: '🚀 Démarrer WorldSnap', eulaAgree: 'J’accepte les conditions', termsTitle: '📜 Conditions (EULA)', map: 'Carte', ranking: 'Tendances', profile: 'Profil', addPhoto: 'Ajouter média', exportMap: 'Partager', view: 'Paysage', gourmet: 'Gourmet', rain: 'Pluie', myMap: 'Ma carte', friends: 'Amis', world: 'Monde', openGoogleMaps: '🧭 Google Maps', saveSpot: '❤️ Enregistrer', saved: '❤️ Enregistré', report: '⚠️ Signaler', block: '🚫 Bloquer', delete: '🗑️ Supprimer', edit: '✏️ Modifier', visited: 'Pays visités', countriesUnit: 'pays', posts: 'Publications', friendCode: 'Code ami', searchPlaceholder: '🔍 Rechercher une ville, #tag...', cacheClear: '🧹 Vider le cache', deleteAccount: '⚠️ Supprimer le compte', logout: '🚪 Déconnexion', close: 'Fermer' } },
  DE: { name: 'Deutschland (ドイツ)', flag: '🇩🇪', region: '🏰 ヨーロッパ', lang: 'de', lat: 51.1657, lon: 10.4515, zoom: 6, dict: { step1Title: 'Schritt 1: Land', step1Desc: 'Land wählen', step2Title: 'Schritt 2', step3Title: 'Schritt 3', next: 'Weiter', back: 'Zurück', startApp: 'Start', eulaAgree: 'Zustimmen', termsTitle: 'AGB', map: 'Karte', ranking: 'Ranking', profile: 'Profil', addPhoto: 'Hinzufügen', exportMap: 'Teilen', view: 'Sicht', gourmet: 'Gourmet', rain: 'Regen', myMap: 'Meine', friends: 'Freunde', world: 'Welt', openGoogleMaps: 'Maps', saveSpot: 'Merken', saved: 'Gemerkt', report: 'Melden', block: 'Blockieren', delete: 'Löschen', edit: 'Ändern', visited: 'Besucht', countriesUnit: 'Länder', posts: 'Beiträge', friendCode: 'Code', searchPlaceholder: 'Suchen...', cacheClear: 'Cache', deleteAccount: 'Konto', logout: 'Abmelden', close: 'Schließen' } },
  ...
  AT: { name: 'Österreich (オーストリア)', flag: '🇦🇹', region: '🏰 ヨーロッパ', lang: 'de', lat: 47.5162, lon: 14.5501, zoom: 7, dict: { step1Title: 'Schritt 1: Land', step1Desc: 'Land wählen', step2Title: 'Schritt 2', step3Title: 'Schritt 3', next: 'Weiter', back: 'Zurück', startApp: 'Start', eulaAgree: 'Zustimmen', termsTitle: 'AGB', home: 'Start', map: 'Karte', ranking: 'Ranking', profile: 'Profil', addPhoto: 'Hinzufügen', exportMap: 'Teilen', view: 'Sicht', gourmet: 'Gourmet', rain: 'Regen', myMap: 'Meine', friends: 'Freunde', world: 'Welt', openGoogleMaps: 'Maps', saveSpot: 'Merken', saved: 'Gemerkt', report: 'Melden', block: 'Blockieren', delete: 'Löschen', edit: 'Ändern', visited: 'Besucht', countriesUnit: 'Länder', posts: 'Beiträge', friendCode: 'Code', searchPlaceholder: 'Suchen...', cacheClear: 'Cache', deleteAccount: 'Konto', logout: 'Abmelden', close: 'Schließen' } },

  // --- 北米・中南米 ---
  US: { name: 'USA (アメリカ)', flag: '🇺🇸', region: '🗽 北米・中南米', lang: 'en', lat: 37.0902, lon: -95.7129, zoom: 4, dict: { step1Title: 'Step 1: Select Nationality', step1Desc: 'Map labels and UI will be displayed in English.', step2Title: 'Step 2: Create Profile', step3Title: 'Step 3: Terms of Service (EULA)', next: 'Next', back: 'Back', startApp: '🚀 Start WorldSnap', eulaAgree: 'I agree to the Terms of Service', termsTitle: '📜 Terms of Service (EULA)', map: 'Map', ranking: 'Trending', profile: 'Profile', addPhoto: 'Add Media', exportMap: 'Share Map', view: 'View', gourmet: 'Gourmet', rain: 'Rainy Day', myMap: 'My Map', friends: 'Friends', world: 'World', openGoogleMaps: '🧭 Open Maps', saveSpot: '❤️ Save', saved: '❤️ Saved', report: '⚠️ Report', block: '🚫 Block', delete: '🗑️ Delete', edit: '✏️ Edit', visited: 'Visited', countriesUnit: 'countries', posts: 'Posts', friendCode: 'Friend Code', searchPlaceholder: '🔍 Search city, #tag...', cacheClear: '🧹 Clear Cache', deleteAccount: '⚠️ Delete Account', logout: '🚪 Log Out', close: 'Close' } },
...
export default function WorldSnapApp() {
  ...
  const handleAddComment = (spotId: string) => {
    ...
    if (check.isViolating) {
      showWarning('⚠️ 暴言・差別発言・不適切な表現が含まれているため、コメントを送信できません。コミュニティガイドラインをお守りください。');
      return;
    }
  ...
  // Instagram等の他アプリへの共有 & 「WorldSnap」ウォーターマーク付きマップ画像生成
  const handleShareMap = async () => {
    if (!exportRef.current) return;
    showToast('🎨 シェア用マップ画像を生成中...');
    try {
      const html2canvasModule = await import('html2canvas');
      const html2canvas = html2canvasModule.default || html2canvasModule;
      const canvas = await html2canvas(exportRef.current, { useCORS: true, scale: 2 });
      
      // 右下に「WorldSnap」のウォーターマークを描画
      const ctx = canvas.getContext('2d');
      if (ctx) {
        const text = '🗺️ WorldSnap';
        ctx.font = 'bold 28px sans-serif';
        const textMetrics = ctx.measureText(text);
        const paddingX = 20;
        const paddingY = 10;
        const x = canvas.width - textMetrics.width - paddingX * 2 - 24;
        const y = canvas.height - 48 - paddingY * 2;

        // 背景バッジ
        ctx.fillStyle = 'rgba(15, 23, 42, 0.82)';
        ctx.beginPath();
        if (ctx.roundRect) {
          ctx.roundRect(x, y, textMetrics.width + paddingX * 2, 44, 22);
        } else {
          ctx.rect(x, y, textMetrics.width + paddingX * 2, 44);
        }
        ctx.fill();
      ...
      canvas.toBlob(async (blob) => {
        ...
        const file = new File([blob], `WorldSnap-${userCountry}.png`, { type: 'image/png' });

        // Web Share API (スマホのInstagram、LINE、X、AirDrop等へ直接渡す)
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
          try {
            await navigator.share({
              title: 'WorldSnap - 旅の思い出マップ',
              text: '世界中を旅して記録中！ #WorldSnap #旅 #絶景',
              files: [file],
            });
          ...
          showToast('💾 マップ画像をダウンロードしました！');
        }
      }, 'image/png');
    } catch {
      showToast('❌ 共有処理に失敗しました');
    }
  };
        ...
        <div style={{ display: currentTab === 'map' ? 'flex' : 'none', flexDirection: 'column', height: '100%', position: 'relative' }}>
          ...
          <div ref={exportRef} style={{ flex: 1, width: '100%', height: '100%', position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', bottom: '65px', right: '14px', zIndex: 400, display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <button
                title="Instagram・他アプリへ共有"
                onClick={handleShareMap}
                style={{ width: '42px', height: '42px', borderRadius: '50%', background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', color: '#fff', border: 'none', boxShadow: '0 4px 14px rgba(0,0,0,0.3)', fontSize: '18px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
              >
                📤
              </button>
            </div>
